                ...
                <div class="tab-pane fade" id="product-edit-option">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="font-weight-semibold" for="productName">Tanggal Mulai</label>
                                <input type="date" class="form-control" id="productName" placeholder="Nama Produk">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-semibold" for="productName">Tanggal Selesai</label>
                                <input type="date" class="form-control" id="productName" placeholder="Nama Produk">
                            </div>
                        </div>
                    </div>
